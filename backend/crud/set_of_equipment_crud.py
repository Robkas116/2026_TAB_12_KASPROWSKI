...
from models.set_of_equipment_model import SetOfEquipment, SetOfEquipmentCreate, SetOfEquipmentUpdate, SetOfEquipmentsPublic, SetOfEquipmentPublic


def create_set_of_equipment(*, session: Session, set_of_equipment_in: SetOfEquipmentCreate) -> SetOfEquipmentPublic:
    ...
    db_obj = SetOfEquipment(
        name=set_of_equipment_in.name,
        version_id=set_of_equipment_in.version_id
    )
...
def get_all_sets_of_equipments(*, session: Session, skip: int = 0, limit: int = 100, version_id: int | None = None) -> SetOfEquipmentsPublic:
...
def get_set_of_equipment_by_id(*, session: Session, set_of_equipment_id: int) -> SetOfEquipmentPublic | None:
...
def update_set_of_equipment(*, session: Session, db_set_of_equipment: SetOfEquipment, set_of_equipment_in: SetOfEquipmentUpdate) -> SetOfEquipmentPublic:
...
def delete_set_of_equipment(*, session: Session, db_set_of_equipment: SetOfEquipment) -> None:
...
def add_equipment_to_set(*, session: Session, db_set: SetOfEquipment, db_equipment: "Equipment") -> SetOfEquipment:
...
def remove_equipment_from_set(*, session: Session, db_set: SetOfEquipment, db_equipment: "Equipment") -> SetOfEquipment:
